...
var fs = require("fs");
fs.chmodSync(process.cwd() + '/ffmpeg', 0777);

var spawn = require("child_process").spawn,
	ffmpeg = spawn.bind(null, process.cwd() + "/ffmpeg"),
...
module.exports.write = function(src, cover, data, callback) {
	var stream = through(),
		dst = getTempPath(src),
		proc = spawnWrite(src, cover, dst, data),
		error = concat();
...
function spawnWrite(src, cover, dst, data) {
	var args = [
		"-i",
		src, // input from src path
        "-i",
        cover, //cover art modification
        "-c",
        "copy",
		"-map",
		"0",
